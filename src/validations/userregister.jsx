...
export const registerSchema = yup.object().shape({
    ...
    userpassword1: yup.string().min(6).max(10).required('Insira a sua senha. '),
    userpassword2: yup.string().min(6).max(10).oneOf([yup.ref('userpassword1'), null], 'As senhas não coincidem. ').required('Confirme a sua senha. '),
})